import { ChangeDetectionStrategy, ChangeDetectorRef, Component, Directive, ElementRef, EventEmitter, HostBinding, HostListener, Injectable, Input, NgModule, Output, Renderer, Renderer2, ViewChild } from '@angular/core';
...
var NgxGalleryComponent = /** @class */ (function () {
    ...
    NgxGalleryComponent.decorators = [
        { type: Component, args: [{
                    ...
                    template: "\n    <div class=\"ngx-gallery-layout {{currentOptions?.layout}}\">\n        <ngx-gallery-image *ngIf=\"currentOptions?.image\" [imageFallback]=\"imageFallback\" [style.height]=\"getImageHeight()\" [images]=\"mediumImages\" [clickable]=\"currentOptions?.preview\" [selectedIndex]=\"selectedIndex\" [arrows]=\"currentOptions?.imageArrows\" [arrowsAutoHide]=\"currentOptions?.imageArrowsAutoHide\" [arrowPrevIcon]=\"currentOptions?.arrowPrevIcon\" [arrowNextIcon]=\"currentOptions?.arrowNextIcon\" [swipe]=\"currentOptions?.imageSwipe\" [animation]=\"currentOptions?.imageAnimation\" [size]=\"currentOptions?.imageSize\" [autoPlay]=\"currentOptions?.imageAutoPlay\" [autoPlayInterval]=\"currentOptions?.imageAutoPlayInterval\" [autoPlayPauseOnHover]=\"currentOptions?.imageAutoPlayPauseOnHover\" [infinityMove]=\"currentOptions?.imageInfinityMove\"  [lazyLoading]=\"currentOptions?.lazyLoading\" [actions]=\"currentOptions?.imageActions\" [descriptions]=\"descriptions\" [showDescription]=\"currentOptions?.imageDescription\" [bullets]=\"currentOptions?.imageBullets\" (onClick)=\"openPreview($event)\" (onActiveChange)=\"selectFromImage($event)\"></ngx-gallery-image>\n\n        <ngx-gallery-thumbnails *ngIf=\"currentOptions?.thumbnails\" [style.marginTop]=\"getThumbnailsMarginTop()\" [style.marginBottom]=\"getThumbnailsMarginBottom()\" [style.height]=\"getThumbnailsHeight()\" [images]=\"smallImages\" [links]=\"currentOptions?.thumbnailsAsLinks ? links : []\" [labels]=\"labels\" [linkTarget]=\"currentOptions?.linkTarget\" [selectedIndex]=\"selectedIndex\" [columns]=\"currentOptions?.thumbnailsColumns\" [rows]=\"currentOptions?.thumbnailsRows\" [margin]=\"currentOptions?.thumbnailMargin\" [arrows]=\"currentOptions?.thumbnailsArrows\" [arrowsAutoHide]=\"currentOptions?.thumbnailsArrowsAutoHide\" [arrowPrevIcon]=\"currentOptions?.arrowPrevIcon\" [arrowNextIcon]=\"currentOptions?.arrowNextIcon\" [clickable]=\"currentOptions?.image || currentOptions?.preview\" [swipe]=\"currentOptions?.thumbnailsSwipe\" [size]=\"currentOptions?.thumbnailSize\" [moveSize]=\"currentOptions?.thumbnailsMoveSize\" [order]=\"currentOptions?.thumbnailsOrder\" [remainingCount]=\"currentOptions?.thumbnailsRemainingCount\" [lazyLoading]=\"currentOptions?.lazyLoading\" [actions]=\"currentOptions?.thumbnailActions\"  (onActiveChange)=\"selectFromThumbnails($event)\"></ngx-gallery-thumbnails>\n\n        <ngx-gallery-preview [images]=\"bigImages\" [imageFallback]=\"imageFallback\" [descriptions]=\"descriptions\" [showDescription]=\"currentOptions?.previewDescription\" [arrowPrevIcon]=\"currentOptions?.arrowPrevIcon\" [arrowNextIcon]=\"currentOptions?.arrowNextIcon\" [closeIcon]=\"currentOptions?.closeIcon\" [fullscreenIcon]=\"currentOptions?.fullscreenIcon\" [spinnerIcon]=\"currentOptions?.spinnerIcon\" [arrows]=\"currentOptions?.previewArrows\" [arrowsAutoHide]=\"currentOptions?.previewArrowsAutoHide\" [swipe]=\"currentOptions?.previewSwipe\" [fullscreen]=\"currentOptions?.previewFullscreen\" [forceFullscreen]=\"currentOptions?.previewForceFullscreen\" [closeOnClick]=\"currentOptions?.previewCloseOnClick\" [closeOnEsc]=\"currentOptions?.previewCloseOnEsc\" [keyboardNavigation]=\"currentOptions?.previewKeyboardNavigation\" [animation]=\"currentOptions?.previewAnimation\" [autoPlay]=\"currentOptions?.previewAutoPlay\" [autoPlayInterval]=\"currentOptions?.previewAutoPlayInterval\" [autoPlayPauseOnHover]=\"currentOptions?.previewAutoPlayPauseOnHover\" [infinityMove]=\"currentOptions?.previewInfinityMove\" [zoom]=\"currentOptions?.previewZoom\" [zoomStep]=\"currentOptions?.previewZoomStep\" [zoomMax]=\"currentOptions?.previewZoomMax\" [zoomMin]=\"currentOptions?.previewZoomMin\" [zoomInIcon]=\"currentOptions?.zoomInIcon\" [zoomOutIcon]=\"currentOptions?.zoomOutIcon\" [actions]=\"currentOptions?.actions\" [rotate]=\"currentOptions?.previewRotate\" [rotateLeftIcon]=\"currentOptions?.rotateLeftIcon\" [rotateRightIcon]=\"currentOptions?.rotateRightIcon\" [download]=\"currentOptions?.previewDownload\" [downloadIcon]=\"currentOptions?.downloadIcon\" [bullets]=\"currentOptions?.previewBullets\" (onClose)=\"onPreviewClose()\" (onOpen)=\"onPreviewOpen()\" (onActiveChange)=\"previewSelect($event)\" [class.ngx-gallery-active]=\"previewEnabled\"></ngx-gallery-preview>\n    </div>\n    ",
...
var EnhanceBackgroundDirective = /** @class */ (function () {
    /**
     * @param {?} el
     * @param {?} renderer
     */
    function EnhanceBackgroundDirective(el, renderer) {
        this.el = el;
        this.renderer = renderer;
     ...
     * @return {?}
     */
    EnhanceBackgroundDirective.prototype.ngOnDestroy = function () {
     ...
     * @return {?}
     */
    EnhanceBackgroundDirective.prototype.removeErrorEvent = function () {
     ...
     * @return {?}
     */
    EnhanceBackgroundDirective.prototype.ngAfterViewInit = function () {
        this.addEvents();
    };
    /**
     * @return {?}
     */
    EnhanceBackgroundDirective.prototype.removeOnLoadEvent = function () {
     ...
     * @return {?}
     */
    EnhanceBackgroundDirective.prototype.addEvents = function () {
        var _this = this;
        if (this.fullSrc) {
            var /** @type {?} */ image = new Image();
            image.src = this.fullSrc;
            image.onload = function () {
                _this.renderer.setStyle(_this.nativeElement, 'background-image', "url('" + _this.fullSrc + "')");
            };
        }
        ...
        if (this.enhanceBackgroundImage && this.errorSrc) {
            ...
            image.onerror = function () {
                console.log('on image error enhance', _this.errorSrc);
                _this.renderer.setStyle(_this.nativeElement, 'background-image', "url('" + _this.errorSrc + "')");
            };
        }
    ...
    EnhanceBackgroundDirective.decorators = [
        { type: Directive, args: [{
     ...
     * @nocollapse
     */
    EnhanceBackgroundDirective.ctorParameters = function () { return [
        { type: ElementRef, },
        { type: Renderer2, },
    ]; };
    EnhanceBackgroundDirective.propDecorators = {
        'fullSrc': [{ type: Input },],
        'errorSrc': [{ type: Input },],
        'enhanceBackgroundImage': [{ type: Input },],
        'loaded': [{ type: Output },],
    };
    return EnhanceBackgroundDirective;
}());

var SrcFallbackDirective = /** @class */ (function () {
    /**
     * @param {?} el
     * @param {?} renderer
     */
    function SrcFallbackDirective(el, renderer) {
        this.el = el;
        this.renderer = renderer;
        this.loaded = new EventEmitter();
     ...
     * @return {?}
     */
    SrcFallbackDirective.prototype.ngOnDestroy = function () {
        this.removeErrorEvent();
        this.removeOnLoadEvent();
    };
    /**
     * @return {?}
     */
    SrcFallbackDirective.prototype.removeErrorEvent = function () {
        if (this.cancelOnError) {
            this.cancelOnError();
        }
    };
     ...
     * @return {?}
     */
    SrcFallbackDirective.prototype.removeOnLoadEvent = function () {
        if (this.cancelOnLoad) {
            this.cancelOnLoad();
        }
    };
     ...
     * @return {?}
     */
    SrcFallbackDirective.prototype.addEvents = function () {
        var _this = this;
        this.cancelOnError = this.renderer.listen(this.nativeElement, this.ERROR_EVENT_TYPE, function () {
            if (_this.nativeElement.getAttribute('src') !== _this.srcFallback) {
                _this.isApplied = true;
                _this.renderer.setAttribute(_this.nativeElement, 'src', _this.srcFallback);
            }
            else {
                _this.removeOnLoadEvent();
            }
        });
        this.cancelOnLoad = this.renderer.listen(this.nativeElement, this.LOAD_EVENT_TYPE, function () { return _this.loaded.emit(_this.isApplied); });
    };
    SrcFallbackDirective.decorators = [
        { type: Directive, args: [{
                    // tslint:disable-next-line
     ...
     * @nocollapse
     */
    SrcFallbackDirective.ctorParameters = function () { return [
        { type: ElementRef, },
        { type: Renderer2, },
    ]; };
    SrcFallbackDirective.propDecorators = {
        'srcFallback': [{ type: Input },],
        'loaded': [{ type: Output },],
    };
    return SrcFallbackDirective;
}());
